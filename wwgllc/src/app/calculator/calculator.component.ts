...
import { CalcMode } from '../admin-calculator/admin-calculator.component';
...
export class CalculatorComponent implements OnInit {  
  ...
  @ViewChild('infoTable') infoTable: ElementRef;
  startDate = "";
  endDate = "";
      ...
      ac.subscribe(data => {
        ...
        data.docs.forEach(document => {
          ...
          aa.get().subscribe(data => {
            ...
            if(counter == max){
              this.infoTable.nativeElement.innerHTML = "";
              calculator(hotspoters, CalcMode.PEOPLES);
            }else{
              counter++;
            }
          });
